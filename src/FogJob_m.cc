...
int FogJobDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='q' && strcmp(fieldName, "queueCount")==0) return base+6;
    if (fieldName[0]=='d' && strcmp(fieldName, "delayCount")==0) return base+7;
    if (fieldName[0]=='a' && strcmp(fieldName, "appId")==0) return base+8;
    if (fieldName[0]=='i' && strcmp(fieldName, "id")==0) return base+9;
    if (fieldName[0]=='r' && strcmp(fieldName, "realTime")==0) return base+10;
...
std::string FogJobDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 6: return long2string(pp->getQueueCount());
        case 7: return long2string(pp->getDelayCount());
        case 8: return long2string(pp->getAppId());
        case 9: return long2string(pp->getId());
        case 10: return long2string(pp->getRealTime());
        default: return "";
    }
}
...
bool FogJobDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 6: pp->setQueueCount(string2long(value)); return true;
        case 7: pp->setDelayCount(string2long(value)); return true;
        case 8: pp->setAppId(string2long(value)); return true;
        case 9: pp->setId(string2long(value)); return true;
        case 10: pp->setRealTime(string2long(value)); return true;
