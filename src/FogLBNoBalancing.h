...
#ifndef SRC_FOGLBNOBALANCING_H_
#define SRC_FOGLBNOBALANCING_H_
...
namespace fog {
    class FogLBNoBalancing: public FogLoadBalancer {
        public:
            FogLBNoBalancing();
            virtual ~FogLBNoBalancing();
